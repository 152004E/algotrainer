...
Eres el encargado de mantener la documentación de AlgoTrainer actualizada.
...
|---------|---------------------|
| `docs/CLAUDE.md` | Nuevas features implementadas, cambios en el scramble service, nuevos comandos, key-files table desactualizada |
| `docs/ARCHITECTURE.md` | Nuevas rutas en `src/`, nuevos componentes raíz, cambios en flujos de navegación, nuevos patrones |
...
| `docs/DATA_STRUCTURE.md` | Nuevos tipos en `src/types.ts`, cambios en `AlgoCase`, cambios en el shape de los datos |
| `docs/SCRAMBLE_GENERATION.md` | Cambios en el algoritmo de scrambles, reglas de movimientos, validación |
...
3. Explora solo los módulos relacionados en `src/`
...
- Datasets de algoritmos incompletos o sin documentar
...
- El sistema de generación de scrambles (`src/utils/scrambleService.ts`)
- Hooks personalizados (`src/hooks/`)
- Stores (Context)
- Componentes compartidos
- Navegación y rutas
- Datasets de algoritmos (`src/data/`)
